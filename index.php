...
<head>
  ...
  <link rel="stylesheet" href="assets/css/components.css?v=61.0">
...
<body>
  ...
  <!-- WhatsApp FAB -->
  <a href="https://wa.me/5930987827215" target="_blank" class="fab-whatsapp" aria-label="Chat en WhatsApp">
  ...
  <script src="assets/js/main.js?v=63.8"></script>
  <script>
    function openCart() {
