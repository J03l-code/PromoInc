...
<body class="hovering">
  ...
  <div id="page-loader" class="page-loader">
    ...
    <div class="loader-logo-container">
      ...
      <div class="loader-icons">
        <!-- Mug -->
        <div class="loader-icon icon-pink"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg></div>
        <!-- Pen -->
        <div class="loader-icon icon-yellow"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/></svg></div>
        <!-- Bag -->
        <div class="loader-icon icon-cyan"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4H6z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg></div>
        <!-- Mouse/Tech -->
        <div class="loader-icon icon-yellow"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a5 5 0 0 0-5 5v10a5 5 0 0 0 10 0V7a5 5 0 0 0-5-5z"/><path d="M12 6V2"/><path d="M7 10h10"/></svg></div>
      </div>
    </div>
  </div>
  ...
  <section class="products-section section" id="productos">
    <div class="container">
      ...
      <div class="products-filter-bar reveal">
        <button class="filter-btn active">Todos</button>
        <button class="filter-btn">Tecnología</button>
        <button class="filter-btn">Escritura</button>
        <button class="filter-btn">Tomatodos</button>
        <button class="filter-btn">Ecología</button>
      </div>
