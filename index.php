...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="assets/css/main.css?v=16.0">
  <link rel="stylesheet" href="assets/css/components.css?v=16.0">
  <link rel="stylesheet" href="assets/css/animations.css?v=16.0">
  <style>
...
<body class="hovering">
  ...
  <div id="page-loader" class="page-loader">
    <div class="loader-logo">
      <img src="assets/images/logo blanco (2).png" alt="PromoInc" style="height: 60px; width: auto; margin-bottom: 20px;">
      ...
      <div class="footer-grid">
        ...
        <div>
          ...
          <ul class="footer-links">
            <li><a href="catalogo.html?cat=tecnologia" class="footer-link">Tecnología & USB</a></li>
            <li><a href="catalogo.html?cat=escritura" class="footer-link">Bolígrafos Metálicos</a></li>
  ...
  <!-- WhatsApp FAB -->
  <a href="https://wa.me/593989398005" target="_blank" class="fab-whatsapp" aria-label="Chat en WhatsApp">
  ...
  <!-- Scripts -->
  <script src="assets/js/cart.js?v=16.0"></script>
